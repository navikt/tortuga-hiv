...
public class KafkaSekvensnummerStorage implements SekvensnummerStorage {

    private static final Logger LOG = LoggerFactory.getLogger(KafkaSekvensnummerStorage.class);
    ...
    public KafkaSekvensnummerStorage(Producer<String, Long> producer, Consumer<String, Long> consumer, TopicPartition partition) {
